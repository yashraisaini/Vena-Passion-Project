export const catMeta = {
  factor8:    { label: 'Factor VIII',     color: '125,211,252' },
  factor9:    { label: 'Factor IX',       color: '167,139,250' },
  nonfactor:  { label: 'Non-factor',      color: '244,63,94'   },
  vwd:        { label: 'Von Willebrand',  color: '34,211,238'  },
  gene:       { label: 'Gene therapy',    color: '201,169,110' },
  supportive: { label: 'Supportive',      color: '74,222,128'  },
}
